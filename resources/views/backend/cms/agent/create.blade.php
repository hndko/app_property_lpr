                ...
                <form action="{{ route('agent.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            <img src="{{ asset('assets/images/avatars/1.png') }}" alt="user-avatar" class="d-block rounded"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group input-group-merge">
                            ...
                            <input type="text" name="no_telpon" id="no_telpon"
                                ...
                                autocomplete="off" value="{{ old('no_telpon') }}">
                        </div>
                        @error('no_telpon')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('instagram') is-invalid @enderror" name="instagram"
                            id="instagram" placeholder="john.doe" autocomplete="off" value="{{ old('instagram') }}">
                        @error('instagram')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('twitter') is-invalid @enderror" name="twitter"
                            id="twitter" placeholder="john.doe" autocomplete="off" value="{{ old('twitter') }}">
                        @error('twitter')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('facebook') is-invalid @enderror" name="facebook"
                            id="facebook" placeholder="john.doe" autocomplete="off" value="{{ old('facebook') }}">
                        @error('facebook')
                            <div class="form-text text-danger">{{ $message }}</div>
                        @enderror
                    </div>
